...
public class SizeXL {
	public static void main(String[] args) throws InterruptedException {
		...
		// click m in size option
		Thread.sleep(3000);
		WebElement m = driver.findElement(By.id("option-label-size-143-item-168"));
		m.click();

		// click l in size option
		Thread.sleep(3000);
		WebElement l = driver.findElement(By.id("option-label-size-143-item-169"));
		l.click();

		// click xl in size option
		Thread.sleep(3000);
		WebElement xl = driver.findElement(By.id("option-label-size-143-item-170"));
		xl.click();
	}
}
