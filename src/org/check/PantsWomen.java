...
public class PantsWomen {
	public static void main(String[] args) throws InterruptedException {
		...
		// now drag pointer to bottom
		WebElement move2 = driver.findElement(By.xpath("(//span[text()='Bottoms'])[1]"));
		A.moveToElement(move2).perform();

		// now click pants
		WebElement move3 = driver.findElement(By.xpath("(//span[text()='Pants'])[1]"));
		move3.click();
