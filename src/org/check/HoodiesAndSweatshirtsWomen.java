...
public class HoodiesAndSweatshirtsWomen {
	public static void main(String[] args) throws InterruptedException {
		...
		// drag pointer to women
		WebElement move1 = driver.findElement(By.xpath("//span[text()='Women']"));
		A.moveToElement(move1).perform();

		// now drag pointer to tops
		WebElement move2 = driver.findElement(By.xpath("(//span[text()='Tops'])[1]"));
		A.moveToElement(move2).perform();

		// now click Hoodies & Sweatshirts
		WebElement move3 = driver.findElement(By.xpath("(//span[text()='Hoodies & Sweatshirts'])[1]"));
		move3.click();
