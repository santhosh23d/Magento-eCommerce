...
public class FitnessEquipment {
	public static void main(String[] args) throws InterruptedException {
		...
		// drag pointer to gear
		WebElement move1 = driver.findElement(By.xpath("//span[text()='Gear']"));
		A.moveToElement(move1).perform();

		// now click fitness equipment
		WebElement move3 = driver.findElement(By.xpath("//span[text()='Fitness Equipment']"));
		move3.click();
