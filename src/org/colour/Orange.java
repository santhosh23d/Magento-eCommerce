...
public class Orange {
	public static void main(String[] args) throws InterruptedException {
		...
		// scroll down and click black colour in colour option
		...
		Thread.sleep(3000);
		WebElement black = driver.findElement(By.id("option-label-color-93-item-49"));
		black.click();

		// click blue colour in colour option
		Thread.sleep(3000);
		WebElement blue = driver.findElement(By.id("option-label-color-93-item-50"));
		blue.click();

		// click orange colour in colour option
		Thread.sleep(3000);
		WebElement orange = driver.findElement(By.id("option-label-color-93-item-56"));
		orange.click();
	}
}
