...
public class SearchBox {
	public static void main(String[] args) throws InterruptedException {
		...
		// click the search box in top right
		WebElement click2 = driver.findElement(By.xpath("//input[@id='search']"));
		click2.click();

		// enter jackets in the search box
		WebElement enter = driver.findElement(By.xpath("//input[@id='search']"));
		enter.sendKeys("jackets");

		// click search button
		WebElement click3 = driver.findElement(By.xpath("//button[@title='Search']"));
		click3.click();
